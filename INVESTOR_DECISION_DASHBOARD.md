...
| 洛阳钼业 603993 | 0 | — | 17.84 | — | HOLD | **UNCHANGED** | **继续持有；可分批加仓1手** |
...
|---|---|---:|---:|---:|---:|
| 洛阳钼业 603993 | **ADD** | 100 | 17.84 | — | 1784.00 |
...
- 本轮深算：**759** 只；研究 BUY **0** / WAIT_PRICE **0** / REJECT **759**。
...
| 603136 | **RAISE_ONLY** | **—** | 价格可以继续研究，但正式价值锚不可用；在估值与 Confidence Gate 补齐前不能升级 BUY/ADD。 |
