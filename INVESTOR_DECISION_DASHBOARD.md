...
> 数据代际=STALE_UPSTREAM；禁止新增仓位；市场=YELLOW；持仓Formal可用=True；持仓减仓/退出目标=1；本轮新增减仓/退出=0；新股正式BUY=0；等价格=0；计划立即投入≈¥0
...
- 本轮深算：**16** 只；研究 BUY **1** / WAIT_PRICE **0** / RESEARCH_GAP **15** / REJECT **0**。
...
- 风险预算：BUILD **1** / PROBE **1** / WATCH **2** / BLOCK **12**；仅人工建议，不自动执行。
