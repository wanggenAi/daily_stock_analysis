...
> 市场=YELLOW；持仓减仓/退出=1；新股正式BUY=0；等价格=0；计划立即投入≈¥1815；盘中价覆盖=4
...
|---|---|---:|---:|---:|---:|
| 洛阳钼业 603993 | **ADD** | 100 | 18.15 | — | 1815.00 |
...
| XD万华化 600309 | **EVENT_TRIGGER_FAILED** | **—** | 价格可以继续研究，但正式价值锚不可用；在估值与 Confidence Gate 补齐前不能升级 BUY/ADD。 |
