...
> 市场=YELLOW；持仓Formal可用=True；持仓减仓/退出目标=1；本轮新增减仓/退出=0；新股正式BUY=0；等价格=0；计划立即投入≈¥1764
...
- 本轮深算：**612** 只；研究 BUY **1** / WAIT_PRICE **0** / REJECT **611**。
...
| 天融信 002212 | **EVENT_TRIGGERED_RUNNING** | **—** | 当前正式动作仍为 NO_ACTION；没有足够证据跨过 BUY/ADD 的全部生产门槛。 |
| 奥特佳 002239 | **EVENT_TRIGGERED_RUNNING** | **—** | 价格可以继续研究，但正式价值锚不可用；在估值与 Confidence Gate 补齐前不能升级 BUY/ADD。 |
| 华昌化工 002274 | **EVENT_TRIGGERED_RUNNING** | **—** | 当前正式动作仍为 NO_ACTION；没有足够证据跨过 BUY/ADD 的全部生产门槛。 |
| 新疆交建 002941 | **EVENT_TRIGGERED_RUNNING** | **—** | 价格可以继续研究，但正式价值锚不可用；在估值与 Confidence Gate 补齐前不能升级 BUY/ADD。 |
