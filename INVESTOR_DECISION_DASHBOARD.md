...
> 市场=YELLOW；持仓减仓/退出=1；新股正式BUY=0；等价格=0；计划立即投入≈¥1764；盘中价覆盖=4/4
...
- 盘中执行价覆盖：**4/4只**；行情状态：**OK**；最新行情时间：**2026-09-16T09:21:57+08:00**；正式动作仍来自冻结 Canonical；缺失/过期盘中价会阻断立即执行，不会把冻结价冒充实时价。
