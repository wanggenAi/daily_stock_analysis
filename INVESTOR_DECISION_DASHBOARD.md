...
- 盘中执行价覆盖：**4/4只**；行情状态：**OK**；最新行情时间：**2026-09-23T11:08:20+08:00**；正式动作仍来自冻结 Canonical；缺失/过期盘中价会阻断立即执行，不会把冻结价冒充实时价。
...
| 润贝航科 001316 | 200 | 25.75 | 28.31 | 9.96 | HOLD_REVIEW | **UNCHANGED** | **持有观察** |
