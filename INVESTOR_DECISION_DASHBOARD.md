...
> 市场=YELLOW；持仓Formal可用=True；持仓减仓/退出目标=1；本轮新增减仓/退出=0；新股正式BUY=0；等价格=0；计划立即投入≈¥0
...
| 洛阳钼业 603993 | 1000 | 18.71 | 19.01 | 1.60 | HOLD | **UNCHANGED** | **继续持有；当前Canonical的一手加仓授权已执行完毕，等待新Canonical重新授权** |
