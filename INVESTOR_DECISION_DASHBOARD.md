...
- 盘中执行价覆盖：**4/4只**；行情状态：**OFF_SESSION**；最新行情时间：**2026-09-23T15:20:10+08:00**；正式动作仍来自冻结 Canonical；缺失/过期盘中价会阻断立即执行，不会把冻结价冒充实时价。
...
- 风险预算：BUILD **0** / PROBE **1** / WATCH **2** / BLOCK **13**；仅人工建议，不自动执行。
