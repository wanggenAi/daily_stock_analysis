...
- 盘中执行价覆盖：**4/4只**；行情状态：**OK**；最新行情时间：**2026-09-23T14:04:17+08:00**；正式动作仍来自冻结 Canonical；缺失/过期盘中价会阻断立即执行，不会把冻结价冒充实时价。
...
|---|---:|---:|---:|---:|---|---|---|
| 国电南瑞 600406 | 200 | 23.13 | 22.40 | -3.14 | REDUCE_25 | **UNCHANGED** | **维持减仓25%目标；本轮无新增减仓/退出信号；目标减50股，当前可执行0股（手数约束；禁止向上取整）** |
| 润贝航科 001316 | 200 | 25.75 | 28.53 | 10.82 | HOLD_REVIEW | **UNCHANGED** | **持有观察** |
| 中国平安 601318 | 400 | 55.97 | 53.91 | -3.67 | HOLD | **UNCHANGED** | **继续持有** |
| 洛阳钼业 603993 | 1100 | 18.62 | 17.70 | -4.96 | HOLD | **UNCHANGED** | **继续持有；历史分批加仓授权已消费，本轮新增可执行0股** |
...
- 本轮深算：**6** 只；研究 BUY **0** / WAIT_PRICE **0** / RESEARCH_GAP **6** / REJECT **0**。
...
- 风险预算：BUILD **0** / PROBE **1** / WATCH **2** / BLOCK **3**；仅人工建议，不自动执行。
