...
- 盘中执行价覆盖：**4/4只**；行情状态：**OK**；最新行情时间：**2026-09-16T14:15:54+08:00**；正式动作仍来自冻结 Canonical；缺失/过期盘中价会阻断立即执行，不会把冻结价冒充实时价。
...
| 中国平安 601318 | 400 | 55.97 | 53.62 | -4.19 | HOLD | **UNCHANGED** | **继续持有** |
| 洛阳钼业 603993 | 0 | — | 17.90 | — | HOLD | **UNCHANGED** | **继续持有；可分批加仓1手** |
...
|---|---|---:|---:|---:|---:|
| 洛阳钼业 603993 | **ADD_LIMIT** | 100 | 17.89 | — | 1789.00 |
