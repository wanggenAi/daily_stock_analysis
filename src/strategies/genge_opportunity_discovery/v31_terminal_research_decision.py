...
explicit RESEARCH_GAP and may be reopened by a new evidence epoch. REJECT is reserved
for explicit logical failure. Formal/Production trading authority is never created here.
"""
...
def build_terminal_decisions(
    *,
    ...
    return {
        ...
        "interpretation": "BUY/WAIT_PRICE are research-only outputs and never create Formal/Production authority. Missing/UNKNOWN evidence remains explicit RESEARCH_GAP; only explicit hard-gate failure is REJECT.",
    }
