...
| 洛阳钼业 603993 | — | HOLD | **继续持有；历史分批加仓授权已消费，本轮新增可执行0股** | HIGH | DEEP_REVIEW_PARTIAL |
...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35493542938`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35493542938`
...
- 终态来源 Lambda：`35493542938`；当前 Lambda：`35493542938`。
- 请求：**852**；研究 BUY：**0**；研究 WAIT_PRICE：**0**；研究 RESEARCH_GAP：**838**；研究 REJECT：**14**。
