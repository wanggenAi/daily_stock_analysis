...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35474801946`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35474801946`
...
- 终态来源 Lambda：`35474801946`；当前 Lambda：`35474801946`。
