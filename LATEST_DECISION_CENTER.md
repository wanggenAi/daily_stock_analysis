...
| Deep 五类硬门槛 + 官方证据 | **ACTIVE** | requested=2 / verified-pass=0 / unresolved=9 |
...
- 终态来源 Lambda：`36055737442`；当前 Lambda：`36056656389`。
...
- 当前可用判断：**0**；其中 ENTRY_NOW **0**；Jev run：`36056243562`。
