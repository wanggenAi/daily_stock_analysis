...
| 润贝航科 001316 | 28.32 | 49.37 | 10.00 | HOLD_REVIEW | **持有观察** | LOW | ACTIVE/seen=187 | DEEP_REVIEW_PARTIAL |
| 中国平安 601318 | 54.19 | 83.07 | -3.17 | HOLD | **继续持有** | MEDIUM | ACTIVE/seen=112 | DEEP_REVIEW_PARTIAL |
| 洛阳钼业 603993 | 17.62 | 28.13 | -5.39 | HOLD | **继续持有；历史分批加仓授权已消费，本轮新增可执行0股** | HIGH | ACTIVE/seen=154 | DEEP_REVIEW_PARTIAL |
...
- **润贝航科 001316**：现价 28.32 / 价值中枢 49.37（价/值 0.57；价值区间 21.64–70.29；区位 **FAIR_VALUE**）；估值信心 **LOW**；Formal **HOLD_REVIEW**；Deep **PASS 2 / FAIL 0 / UNKNOWN 3**；Lifecycle **ACTIVE / seen=187**；原因码：`VALUATION_CONFIDENCE_LOW;REALISTIC_GROWTH_UNSTABLE`。
...
- **洛阳钼业 603993**：现价 17.62 / 价值中枢 28.13（价/值 0.63；价值区间 18.03–43.07；区位 **BELOW_VALUE**）；估值信心 **HIGH**；Formal **HOLD**；Deep **PASS 4 / FAIL 0 / UNKNOWN 1**；Lifecycle **ACTIVE / seen=154**；原因码：`FUNDAMENTALS_INTACT;NO_ACTION_THRESHOLD`。
