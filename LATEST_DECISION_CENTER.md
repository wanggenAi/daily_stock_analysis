...
| Candidate Lifecycle 持续研究记忆 | **ACTIVE** | active=118 / dormant=8 / archived-invalidated=0 / events=10458 / focus=4 |
| Deep 五类硬门槛 + 官方证据 | **ACTIVE** | requested=18 / verified-pass=0 / unresolved=70 |
...
- 终态来源 Lambda：`36082040045`；当前 Lambda：`36083122406`。
...
- 当前可用判断：**0**；其中 ENTRY_NOW **0**；Jev run：`36082518418`。
