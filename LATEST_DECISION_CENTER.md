...
| Deep 五类硬门槛 + 官方证据 | **ACTIVE** | requested=22 / verified-pass=228 / unresolved=89 |
| Deep Provenance 证据审计 | **ACTIVE** | audit=True / run=35684308809 / unverified-pass=0 |
...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35683878901`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35683878901`
...
- 终态来源 Lambda：`35683878901`；当前 Lambda：`35683878901`。
