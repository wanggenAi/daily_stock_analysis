...
| Candidate Lifecycle 持续研究记忆 | **ACTIVE** | active=118 / dormant=8 / archived-invalidated=0 / events=10508 / focus=4 |
...
- 终态来源 Lambda：`36109049765`；当前 Lambda：`36110564171`。
...
- 当前可用判断：**0**；其中 ENTRY_NOW **0**；Jev run：`36109627192`。
