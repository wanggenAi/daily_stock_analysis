...
| Deep Provenance 证据审计 | **ACTIVE** | audit=True / run=35644996613 / unverified-pass=0 |
...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35644304201`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35644304201`
...
- 请求但未进入本次研究工件：**无**。
- 上一次完整终态 run：`35644304201`；执行 **SUCCESS**；研究终态 **EVIDENCE_EXHAUSTED**。
- 是否需要你手工开启下一轮：**False**。
...
- 终态来源 Lambda：`35644304201`；当前 Lambda：`35644304201`。
