...
| 润贝航科 001316 | 28.31 | 49.37 | 9.96 | HOLD_REVIEW | **持有观察** | LOW | ACTIVE/seen=187 | DEEP_REVIEW_PARTIAL |
| 中国平安 601318 | 54.13 | 83.07 | -3.28 | HOLD | **继续持有** | MEDIUM | ACTIVE/seen=112 | DEEP_REVIEW_PARTIAL |
...
- **润贝航科 001316**：现价 28.31 / 价值中枢 49.37（价/值 0.57；价值区间 21.64–70.29；区位 **FAIR_VALUE**）；估值信心 **LOW**；Formal **HOLD_REVIEW**；Deep **PASS 2 / FAIL 0 / UNKNOWN 3**；Lifecycle **ACTIVE / seen=187**；原因码：`VALUATION_CONFIDENCE_LOW;REALISTIC_GROWTH_UNSTABLE`。
- **中国平安 601318**：现价 54.13 / 价值中枢 83.07（价/值 0.65；价值区间 未形成完整区间；区位 **UNKNOWN**）；估值信心 **MEDIUM**；Formal **HOLD**；Deep **PASS 0 / FAIL 0 / UNKNOWN 5**；Lifecycle **ACTIVE / seen=112**；原因码：`INSURER_EVIDENCE_VALID;NO_ACTION_THRESHOLD;price_to_neutral=0.656<1.00`。
