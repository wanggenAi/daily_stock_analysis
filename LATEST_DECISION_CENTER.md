...
|---|---:|---:|---:|---|---|---|---|---|
| 国电南瑞 600406 | 22.05 | 17.46 | -4.65 | REDUCE_25 | **维持减仓25%目标；本轮无新增减仓/退出信号；目标减50股，当前可执行0股（手数约束；禁止向上取整）** | HIGH | ACTIVE/seen=178 | DEEP_REVIEW_PARTIAL |
| 润贝航科 001316 | 28.11 | 49.37 | 9.19 | HOLD_REVIEW | **持有观察** | LOW | ACTIVE/seen=180 | DEEP_REVIEW_PARTIAL |
| 中国平安 601318 | 53.37 | 83.07 | -4.64 | HOLD | **继续持有** | MEDIUM | ACTIVE/seen=105 | DEEP_REVIEW_PARTIAL |
| 洛阳钼业 603993 | 17.51 | 28.13 | -5.98 | HOLD | **继续持有；历史分批加仓授权已消费，本轮新增可执行0股** | HIGH | ACTIVE/seen=147 | DEEP_REVIEW_PARTIAL |
...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35618926319`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35618926319`
...
- 请求但未进入本次研究工件：**无**。
- 上一次完整终态 run：`35618926319`；执行 **SUCCESS**；研究终态 **EVIDENCE_EXHAUSTED**。
- 是否需要你手工开启下一轮：**False**。
