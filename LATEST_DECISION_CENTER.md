...
- 深算资料来源：**AUTOMATIC_DEEP_CALCULATION**；资料 Lambda：`35609598979`；与当前运行一致：**True**
- 深算 profile lineage 与当前 runtime 一致。
- Lambda run：`35609598979`
...
- 终态来源 Lambda：`35609598979`；当前 Lambda：`35609598979`。
- 请求：**16**；研究 BUY：**0**；研究 WAIT_PRICE：**0**；研究 RESEARCH_GAP：**16**；研究 REJECT：**0**。
- 高吸引力但证据不足、优先补证：600406 国电南瑞(quant=37.7717)；001316 润贝航科(quant=35.5701)；601318 中国平安(quant=33.0392)；603993 洛阳钼业(quant=31.0177)；000576 甘化科工(quant=75.2261)；603209 兴通股份(quant=68.2587)；603160 汇顶科技(quant=65.9223)；688162 巨一科技(quant=65.7322)
